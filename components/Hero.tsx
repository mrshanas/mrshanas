...
const Hero = () => {
  return (
    <div className="flex flex-col md:flex-row mx-auto my-8">
      <div className="flex flex-col md:basis-1/2 w-full basis-full">
        ...
        <div className="text-lightGreen text-7xl text-center font-bold leading-[108px] tracking-[0.055rem] border-solid border-lightGreen">
          <TypeWriter
            options={{
              strings: [
                "Backend Developer",
