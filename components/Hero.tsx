      ...
      <div className="flex flex-col-reverse md:flex-row">
        ...
        <div className="basis-1/2 flex ">
          <div className="flex flex-col justify-start text-center md:text-left md:justify-center p-2 md:pl-20 space-y-4">
            ...
            <h2 className="text-purple text-5xl font-extrabold">Mr Shanas</h2>
            <p className="text-black font-semibold md:text-2xl">
            ...
            <Link href="/contact">
              <button className="bg-purple md:w-[40%] p-2 text-white font-bold rounded-lg">
                Contact Me
              </button>
            </Link>
          </div>
        ...
        <div className="basis-1/2 flex justify-center items-center">
          <div className="relative h-[15rem] w-[15rem] border-4 md:h-80 md:w-80 rounded-full md:border-8 border-purple">
            <Image
              src={shanas}
              layout="fill"
              alt="mrshanas photo"
